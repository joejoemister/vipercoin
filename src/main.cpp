...
// Copyright (c) 2013-2014 The Vipercoin developers
...
uint256 hashGenesisBlock("0x0000004a26c8eaa65299ab025e08ee8b580ff2d2833983905b7e3bc11bc41cd1");
static const unsigned int timeGenesisBlock = 1515901791;
...
const string strMessageMagic = "Vipercoin Signed Message:\n";
                              ...
                              enum GetMinFee_mode mode) const
{
    ...
    if (fAllowFree)
    {
        if (nBlockSize == 1)
        {
            ...
            // (about 4500 VIPER if made of 50 VIPER inputs)
            if (nBytes < 10000)
                nMinFee = 0;
        }
        else
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0000004a26c8eaa65299ab025e08ee8b580ff2d2833983905b7e3bc11bc41cd1");
    }
...
*/
        ...
        // Genesis block
        const char* pszTimestamp = "13jan2018";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = 30337819;

        if (fTestNet)
        {
            block.nTime    = 1515901791;
            block.nNonce   = 30337819;
        }
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xb182ee7f94a366f417b26677181aa8a72ba4c36c1be037159ba47be448481b4c"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("VipercoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("VipercoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("VipercoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("vipercoin-miner");
    ...
    try { loop {
        ...
        printf("Running VipercoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("VipercoinMiner terminated\n");
        throw;
    }
}
