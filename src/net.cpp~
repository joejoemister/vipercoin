...
static const char *strMainNetDNSSeed[][2] = {
	{"165.227.96.129", "165.227.96.129"},
	{"71.150.156.246", "71.150.156.246"},
    {NULL, NULL}
};
...
{
	mapMultiArgs["-addnode"].push_back("vipercoin.org");
	mapMultiArgs["-addnode"].push_back("eu3.vipercoin.com");
	mapMultiArgs["-addnode"].push_back("ny2.vipercoin.com");
	mapMultiArgs["-addnode"].push_back("la1.vipercoin.com");
	mapMultiArgs["-addnode"].push_back("cg1.vipercoin.com");
    {
        LOCK(cs_vAddedNodes);
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Vipercoin is probably already running."), addrBind.ToString().c_str());
        else
