...
const QString BITCOIN_IPC_PREFIX("vipercoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click vipercoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start vipercoin: click-to-pay handler");
    else
...
{
    // clicking on vipercoin: URLs creates FileOpen events on the Mac:
